...
Using a search word "parenting" in Amazon.sg, I hit 75 pages of search results of about 1400 books. I then scrapped information on the book title. While I have data on the book titles for all 75 pages, I, unfortunately, could only scrap additional meta-data on the date of publication for only the first 20 pages because some information were not available (i.e. missing scrapped data). **And missing data will screw up the scrapping**. This is something that I do not (yet) have the knowledge/skills to resolve. Nonetheless, I can only look at publication dates for the first twenty pages of results. I also still have data on the book titles for all the earch results. 
...
```{r Word Freq Plot, echo=TRUE, fig.width=7, fig.height=7}
...
```{r Prepare data for mumdad comparisons, echo=FALSE, results='hide'}
...
### Identify the possible number of topics using exclusivity and semantic coeherence
...
diag %>%
    ...
    scale_color_manual( values = c( "mean"=nus_orange , "median"= nus_blue) )
...
<br/><br/>
```{r plot topics and words, echo = FALSE, warning = FALSE, message = FALSE, fig.width=9, fig.height=9}
